		...
		<div class="col-md-8 mx-auto" id="listData">
			...
			<div class="card border-0 mb-5">
				<div class="card-body fit-body-post">
					...
					<p class="show-comment-link" onclick="seeComment('section-comment-<?= $user_post['post_id'] ?>')">Show Comment</p>
				</div>
				<div class="card-footer border-0 mb-5 d-none" id="section-comment-<?= $user_post['post_id'] ?>">
					...
					<?= form_open(); ?>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="comment_<?= $user_post['post_id']; ?>" aria-describedby="comment_<?= $user_post['post_id']; ?>Help">
						...
						<div class="row my-3">
							<div class="col-md-12">
								<div class="d-flex align-items-center mb-3">
									...
									<div class="ml-4 <?= $user_comment['username'] == $user['username'] ? '' : 'd-none' ?>">
